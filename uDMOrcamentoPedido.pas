...
type
  TDMOrcamentoPedido = class(TDataModule)
    ...
    qryDadosOrcPedidoORCPED_CORALUMINIO: TStringField;
    qryDadosOrcPedidoORCPED_CORCOMPONENTE: TStringField;
    cdsDadosOrcPedidoORCPED_CORALUMINIO: TStringField;
    cdsDadosOrcPedidoORCPED_CORCOMPONENTE: TStringField;
    ...
    qryViewOrcPedido_BuscaORCPED_CORALUMINIO: TStringField;
    qryViewOrcPedido_BuscaORCPED_CORCOMPONENTE: TStringField;
    ...
    cdsViewOrcPedido_BuscaORCPED_CORALUMINIO: TStringField;
    cdsViewOrcPedido_BuscaORCPED_CORCOMPONENTE: TStringField;
  private
