...
type
  TFCadVendaComissionada = class(TFCadPadrao)
...
var
  FCadVendaComissionada: TFCadVendaComissionada;
...
procedure TFCadVendaComissionada.btCAClienteClick(Sender: TObject);
begin
  inherited;
...
procedure TFCadVendaComissionada.btCAVendedorClick(Sender: TObject);
begin
  inherited;
  FSelecionarCli := TFSelecionarCli.Create(nil);
...
procedure TFCadVendaComissionada.btEXClienteClick(Sender: TObject);
begin
  inherited;
  ibCadastroVEC_CLIENTE_ID.Clear;
end;

procedure TFCadVendaComissionada.btEXVendedorClick(Sender: TObject);
begin
  inherited;
  ibCadastroVEC_VENDEDOR_ID.Clear;
end;

procedure TFCadVendaComissionada.FormShow(Sender: TObject);
begin
  inherited;
  qConsulta.Close;
  qConsulta.Open;
...
procedure TFCadVendaComissionada.ibCadastroNewRecord(DataSet: TDataSet);
begin
  inherited;
  ibCadastroVEC_DATA.AsDateTime := Now;
end;

procedure TFCadVendaComissionada.btGerarFinanceiroClick(Sender: TObject);
begin
  inherited;
...
procedure TFCadVendaComissionada.btEXFinanceiroClick(Sender: TObject);
begin
  inherited;
...
procedure TFCadVendaComissionada.ExisteFinanceiro(pId:Integer);
var bExiste : Boolean;
begin
...
procedure TFCadVendaComissionada.EntrouAbaCadastro;
begin
  inherited;
  ExisteFinanceiro(qConsultaID.Value);
end;

procedure TFCadVendaComissionada.btCAFinanceiroClick(Sender: TObject);
begin
  inherited;
...
procedure TFCadVendaComissionada.btSelecionarFinanceiroClick(Sender: TObject);
var vValor : Extended;
begin
  inherited;
...
procedure TFCadVendaComissionada.FormCreate(Sender: TObject);
begin
  inherited;
  ListaFinancerioId := TStringList.Create;
end;

procedure TFCadVendaComissionada.ibCadastroAfterPost(DataSet: TDataSet);
var i : Integer;
begin
  inherited;
...
procedure TFCadVendaComissionada.ibCadastroBeforePost(DataSet: TDataSet);
begin
  inherited;
  if (PageControl1.ActivePage=tsFinanceiro) then
  begin
...
procedure TFCadVendaComissionada.btEXFinanceiro2Click(Sender: TObject);
begin
  inherited;
