...
begin
  ...
  RLLabel18.Caption := 'RECONHEÇO(EMOS) A EXATIDÃO DESTA DUPLICATA DE VENDA MERCANTIL/PRESTAÇÃO DE SERVIÇOS, NA IMPORTÂNCIA ACIMA';
  {strReplace}RLLabel19.Caption := 'QUE PAGAMOS(REMOS) À '+DMDuplicata.cdsViewDuplicata_EmitenteEMIT_RAZAOSOCIAL.AsString+
