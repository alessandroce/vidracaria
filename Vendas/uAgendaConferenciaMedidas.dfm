inherited FCadAgendaConferenciaMedidas: TFCadAgendaConferenciaMedidas
  Left = 306
  Top = 167
  Height = 700
  Caption = 'FCadAgendaConferenciaMedidas'
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  inherited qConsulta: TIBQuery
    SQL.Strings = (
      ...
      '       when(agenda.conm_status=2) then '#39'CONCU'#205'DO'#39
      '       when(agenda.conm_status=2) then '#39'CANCELADO'#39
      '       end status'
      '  from agenda'
