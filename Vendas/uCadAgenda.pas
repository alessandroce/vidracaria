...
procedure TFCadAgenda.CarregarConsulta;
begin
  inherited;
  //qConsulta.Close;
...
procedure TFCadAgenda.ibCadastroBeforePost(
  DataSet: TDataSet);
begin
  inherited;
...
procedure TFCadAgenda.ibCadastroNewRecord(
  DataSet: TDataSet);
begin
  inherited;
...
procedure TFCadAgenda.cxDateNavigator1SelectionChanged(
...
procedure TFCadAgenda.ibCadastroAfterPost(
  DataSet: TDataSet);
begin
  inherited;
  qTmp.Close;
...
procedure TFCadAgenda.CarregarDados;
begin
...
procedure TFCadAgenda.rgTipoAgendaClick(Sender: TObject);
begin
  inherited;
  CarregarDados;
end;

procedure TFCadAgenda.rgStatusClick(Sender: TObject);
begin
  inherited;
  CarregarDados;
end;
