unit uRelVencimentoContasPagar;
...
type
  TFRelVencimentoContasPagar = class(TFRelatorioPadrao)
...
var
  FRelVencimentoContasPagar: TFRelVencimentoContasPagar;
...
procedure TFRelVencimentoContasPagar.bt_CancelarExecute(Sender: TObject);
begin
  inherited;
  Close;
end;

procedure TFRelVencimentoContasPagar.bt_LimparExecute(Sender: TObject);
begin
  inherited;
  IdCli := 0;
  Edit1.Clear;
...
procedure TFRelVencimentoContasPagar.bt_okExecute(Sender: TObject);
...
begin
  ...
  begin
    {pagar}sRelatorio := 'FIN006_VENCIMENTO_CONTAS_PAGAR';
...
procedure TFRelVencimentoContasPagar.bt_SelCliExecute(Sender: TObject);
begin
  inherited;
...
procedure TFRelVencimentoContasPagar.FormShow(Sender: TObject);
begin
  inherited;
